...
**Live as of [v0.9.3](https://github.com/Pintuzoft/OSAntiCheat/releases):** all six Tier-1 axes
...
|---|---|---|
| **Null test** ⭐ | Crosshair on an **unspotted** enemy's *present* position more often than its *1.5s-past* position (McNemar z — skill cancels, playtime doesn't confound) | Shadowed live: leaks on held pre-aim angles; being replaced by the kill-anchored deadaim axis |
| **Wallhack (track/gaze)** | Aim/gaze follows a moving unspotted enemy through geometry (CS2 spotted state as the LOS signal) | Shadowed: first versions flagged normal crosshair placement — kept for data collection |
