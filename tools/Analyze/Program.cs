...
//
// The idea (the owner's): the best legit players define what is physically achievable. Anything
...
// The owner's point: the archive can't be assumed clean, but someone who has played the server for
