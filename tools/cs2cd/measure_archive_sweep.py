...
def main(path, min_shots=200, top=25):
    ...
    # DemoReplay writes UTF-8; Windows Python defaults to the ANSI code page and turns
    # Swedish names into mojibake. The names are the whole point of the sanity check.
